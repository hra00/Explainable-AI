...
def get_extended_model(image_shape):
	...
	model.add(ConvLayer(64, kernel_size=(3,3), padding="same", kernel_initializer="he_normal", name="block1_conv3"))
	model.add(MaxPool2D(3,3, name="maxpool_1"))

	# block 2 - 128 filters (3 times)
	model.add(ConvLayer(128, kernel_size=(3,3), padding='same', kernel_initializer='he_normal', name="block2_conv1"))
	model.add(ConvLayer(128, kernel_size=(3,3), padding='same', kernel_initializer='he_normal', name="block2_conv2"))
	model.add(MaxPool2D(3,3, name="maxpool_2"))

	# block 3 - 256 filters (3 times)
	model.add(ConvLayer(256, kernel_size=(3,3), padding='same', kernel_initializer='he_normal', name="block3_conv1"))
	model.add(ConvLayer(256, kernel_size=(3,3), padding='same', kernel_initializer='he_normal', name="block3_conv2"))
	model.add(ConvLayer(256, kernel_size=(3,3), padding='same', kernel_initializer='he_normal', name="block3_conv3"))
